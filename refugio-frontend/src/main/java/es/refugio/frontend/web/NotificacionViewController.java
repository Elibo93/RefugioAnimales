...
public class NotificacionViewController {
    ...
    public String listar(Model model,
        ...
        model.addAttribute(ModelAttribute.FRAGMENTO_CONTENIDO.getName(),
                FragmentoContenido.Notificacion_LIST.getPath());
        ...
        try {
            ...
            for (Map<String, Object> n : notificaciones) {
                ...
                if ("LOGRO_DESBLOQUEADO".equals(n.get("tipo")) && Boolean.FALSE.equals(n.get("leida"))) {
                    ...
                    notificacionService.marcarComoLeida((Integer) n.get("id"));

                    String mensaje = (String) n.get("mensaje");

                    // Extraer la imagen basada en el texto del mensaje (antes de traducir)
                    String imageUrl = "";
                    if (mensaje.contains("Primeros Pasos")) {
                        imageUrl = "/images/logros/primeros-pasos.png";
                    } else if (mensaje.contains("Compromiso Firme")) {
                        imageUrl = "/images/logros/compromiso-firme.png";
                    } else if (mensaje.contains("Leyenda del Refugio")) {
                        imageUrl = "/images/logros/leyenda-refugio.png";
                    } else if (mensaje.contains("Corazón Generoso")) {
                        imageUrl = "/images/logros/corazon-generoso.png";
                    } else if (mensaje.contains("Mecenas de Huellas")) {
                        imageUrl = "/images/logros/mecenas-huellas.png";
                    } else if (mensaje.contains("Ángel Guardián")) {
                        imageUrl = "/images/logros/angel-guardian.png";
                    }
     ...
     * 1. Texto hardcodeado en español por el backend (donaciones, logros) →
     * traducción por contenido
    ...
    private void translateNotification(Map<String, Object> n, java.util.Locale locale) {
        ...
        // Caso 1: El backend guardó claves i18n directamente (ej:
        // notificacion.voluntario.*)
        ...
        if (tituloResolved != null) {
            ...
            if (mensaje != null) {
                ...
                if (mensajeResolved != null)
                    n.put("mensaje", mensajeResolved);
            }
        ...
        if (titulo.contains("Logro Desbloqueado")) {
            ...
            String keyDesc = null;
            if (mensaje.contains("Primeros Pasos")) {
                keyName = "achievement.name.primeros_pasos";
                keyDesc = "achievement.desc.primeros_pasos";
            } else if (mensaje.contains("Compromiso Firme")) {
                keyName = "achievement.name.compromiso_firme";
                keyDesc = "achievement.desc.compromiso_firme";
            } else if (mensaje.contains("Leyenda del Refugio")) {
                keyName = "achievement.name.leyenda_refugio";
                keyDesc = "achievement.desc.leyenda_refugio";
            } else if (mensaje.contains("Coraz\u00f3n Generoso")) {
                keyName = "achievement.name.corazon_generoso";
                keyDesc = "achievement.desc.corazon_generoso";
            } else if (mensaje.contains("Mecenas de Huellas")) {
                keyName = "achievement.name.mecenas_huellas";
                keyDesc = "achievement.desc.mecenas_huellas";
            } else if (mensaje.contains("\u00c1ngel Guardi\u00e1n")) {
                keyName = "achievement.name.angel_guardian";
                keyDesc = "achievement.desc.angel_guardian";
            }
            ...
            if (keyName != null && keyDesc != null) {
                ...
                n.put("mensaje", messageSource.getMessage("alert.achievement.subtitle",
                        new Object[] { localName, localDesc }, mensaje, locale));
            }
