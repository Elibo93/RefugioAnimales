...
import es.refugio.animales.refugio.infraestructure.db.jpa.repository.voluntario.VoluntarioEntityJpaRepository;
import es.refugio.animales.refugio.infraestructure.db.jpa.repository.voluntario.VoluntarioJpaRepositoryImpl;
