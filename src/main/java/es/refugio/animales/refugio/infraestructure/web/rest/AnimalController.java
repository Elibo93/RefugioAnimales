...
import es.refugio.animales.refugio.infraestructure.mapper.AnimalMapper;
...
public class AnimalController {
    ...
    @PostMapping
    public ResponseEntity<AnimalResponse> createAnimal(@Valid @RequestBody AnimalRequest AnimalRequest) {
        CreateAnimalCommand comando = AnimalMapper.toCommand(AnimalRequest);
    ...
    public ResponseEntity<AnimalResponse> updateAnimal(@PathVariable Integer id,
        ...
        EditAnimalCommand comando = AnimalMapper.toEditCommand(new AnimalId(id), AnimalRequest);
