...
public class VoluntarioController {
    ...
    public ResponseEntity<VoluntarioResponse> create(@Valid @RequestBody VoluntarioRequest request) {
        ...
        Voluntario voluntario = createVoluntarioService.create(command);
        return ResponseEntity.status(HttpStatus.CREATED).body(VoluntarioMapper.toResponse(voluntario));
    }

    @PutMapping("/{id}")
    public ResponseEntity<VoluntarioResponse> update(@PathVariable Integer id, @Valid @RequestBody VoluntarioRequest request) {
